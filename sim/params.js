...
module.exports = {
  ...
  // msGap(2026-07-22 ユーザー指示「自動購入は廃止。実績・スキル間隔も分散」): 実績/スキル研究(ms_/msk_)の
  // 生涯初取得は直近の解放から msGap 秒あけて最安1つずつ(=㉚解放ラッシュの主犯だった一括自動購入を分散)。
  // minGap=0(設備/研究/段階の待ちゼロ)と両立: 分散するのは自動取得の実績/スキル研究だけ。
  reveal: { minGap: 0, msGap: 30 },
