...
module.exports = {
  ...
  res: {
    ...
    fingerBase: 0.01, fingerSqrt: 0.045, fingerStage: 0.002, fingerCritBase: 2.2, fingerCritGrow: 10.0, critHalf: 1.0, // critHalf新設(2026-07-18 R26改 ユーザー指示「上限撤廃・上昇は緩やかに・最終的に両どり」): 素の会心率=0.995×score/(score+critHalf)の双曲線=ハードキャップなしで永遠に成長し99.5%へ漸近。装備/研究のcritAddを足せば早期に天井付近へ(両どり)。旧critBaseCap0.6(ハード上限)は「強化要素に上限があるのが気に食わない」で撤廃 // critBase 2.0→2.2(2026-07-11 ①finger: S2 run1のlift1.1996=基準1.2を丸め1つ分割れ。会心率(㉓固定)は不変・倍率の基礎項のみ)
