...
module.exports = {
  ...
  monster: {
    ...
    killValMul: { balanced: 7.6, hunt: 6.0, default: 1 }, // balanced 6.5→7.2(2026-07-18 R25 ㉘balanced run2討伐9.6%→10.2%。7.5は⑫click1位強奪で不可の前科=7.2は要⑫検証) // 方針係数(2026-07-14 ㉘balanced中盤討3-6%対策) // hunt 1.5(2026-07-17 ⑫: hunt方針の討伐即時収入を主役らしく=1位周回の復元)
