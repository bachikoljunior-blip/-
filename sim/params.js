...
module.exports = {
  ...
  // 第0回コスト再算定ルール(2026-07-09 ユーザー): costExp0 = floor(log10(全方針の第0回転生時の所持クッキーの最小値))、
  // ただしその10のべき乗が1000万(10^7)以上のときだけ採用。diag_prestige0.js で実測。
  // 実測(24h): 最小=S8 1.0007e6 → 10^6 <10^7 なので costExp0=6 のまま(ほぼ全方針が10^6到達で即転生するため)。
  ...
  rw: {
    ...
    monsterStayChain: 0.03, chainPrepPersist: 0.25,
    beastScent: 0.5,
