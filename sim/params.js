...
module.exports = {
  ...
  // 実績研究の取得規律(2026-07-22 ユーザー指示「自動購入は廃止。実績達成したら購入可=手動の熟慮購入」):
  // ・msBudgetRatio: 一括自動購入をやめ、達成済み・未取得の最安を所持クッキーの ratio 以内で1tick1件=熟慮購入(機会費用あり)。
  // ・msGap: そのうち「生涯初=解放イベント」だけ直近解放から msGap 秒あけて分散(㉚間隔分散)。再取得は待たせない。
  // minGap=0=設備/研究/段階は待ちゼロ。
  reveal: { minGap: 0, msBudgetRatio: 0.5, msGap: 30 },
