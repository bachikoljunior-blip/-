...
module.exports = {
  ...
  quota: {
    ...
    reachGainFrac: 0.9, reachCoef: 1.2, reachPow: 10, reachMinSec: 600, reachMaxSec: 6000, reachEmaAlpha: 0.35 // reachGainFrac(2026-07-11 第2再設計): 未達=獲得予定PT≥次スキル最安×0.9(時間比は0設定時のフォールバック) // reachCoef 2.0→1.2(2026-07-11 T3a廃止後: 未達はT3b専用になったのでρ*0.93→0.98へ後ろ倒し。前回より長い周回の維持率70-79%割れを救う。掃引: S4 33→38・S9 35→41・S3 44→46・S1 43→44)
  },
