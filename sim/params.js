...
module.exports = {
  ...
  res: {
    ...
    fingerBase: 0.01, fingerSqrt: 0.045, fingerStage: 0.002, fingerCritBase: 2.2, fingerCritGrow: 10.0, critBaseCap: 0.6, // critBaseCap新設(2026-07-18 R26 ユーザー指示「素の会心率下げれば装備の会心率が生きる」): 素の会心率は60%で頭打ち・99.5%へは装備/研究のcritAddで埋める=会心率装備が育ったクリック型にも意味を持つ // critBase 2.0→2.2(2026-07-11 ①finger: S2 run1のlift1.1996=基準1.2を丸め1つ分割れ。会心率(㉓固定)は不変・倍率の基礎項のみ)
